...
module.exports = [
  {
    ...
    config: {
      ...
      validate: {
        ...
        payload: Joi.object({
          bulkTransferId: Joi.string().required().description('Id of bulk transfer').label('@ Bulk Transfer Id must be in a valid GUID format. @'),
          bulkQuoteId: Joi.string().required().description('Id of bulk quote').label('@ Bulk Quote Id must be in a valid GUID format. @'),
