...
exports.putPartiesByTypeId = function (request, h) {
  ...
  Logger.info(`IN PAYERFSP:: PUT /payerfsp/parties/${request.params.tyepe}/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.putPartiesByTypeIdAndError = function (request, h) {
  console.log((new Date().toISOString()), `IN PAYERFSP:: PUT /payerfsp/parties//${request.params.tyepe}/${request.params.id}/error`, request.payload)
  myCache.set(request.params.id, request.payload)
...
exports.getcorrelationId = function (request, h) {
  ...
  Logger.info(`IN PAYERFSP:: PUT /payerfsp/correlationid/${request.params.id}, CACHE: [${JSON.stringify(myCache.get(request.params.id))}]`)
